...
This repository contains maps developed in QGIS for cartographic representation at different spatial scales. The maps are designed to support geographic visualization and interpretation of spatial patterns related to physical and environmental characteristics.
...
- Apply QGIS tools for thematic cartographic production
...
# Data
  ...
  - *Altimetry Data*
    - Source: DIVA - GIS
    - Description: Altimetry geotiff for South America 
    - 🔗 [Download Data](https://diva-gis.org/data.html)


- *Territorial boundaries of South America*
    - Source: Natural Earth
    - Description: Boundaries of South America countries
    - 🔗 [Download Data](https://www.naturalearthdata.com/downloads/10m-cultural-vectors/)
